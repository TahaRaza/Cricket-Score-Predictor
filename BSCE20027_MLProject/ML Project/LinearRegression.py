...
# Example prediction
example_input = pd.DataFrame({'venue': ["The Rose Bowl"], 'bat_team': ['South Africa'], 'bowl_team': ['England'], 'batsman': ['AB de Villiers'],
                              'bowler': ['Jofra Archer'], 'runs': [50], 'wickets': [3], 'overs': [8.5], 'runs_last_5': [35], 'wickets_last_5': [1],
